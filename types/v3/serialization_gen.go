...
func (z *SeriesGroup) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if cap(z.Series) >= int(zb0002) {
		...
		z.Series = make([]*TimeSeriesBinary, zb0002)
	}
	for za0001 := range z.Series {
		if dc.IsNil() {
			...
			if z.Series[za0001] == nil {
				z.Series[za0001] = new(TimeSeriesBinary)
			}
	...
	if cap(z.Metadata) >= int(zb0003) {
		...
		z.Metadata = make([]*TimeSeriesBinary, zb0003)
	}
	for za0002 := range z.Metadata {
		if dc.IsNil() {
			...
			z.Metadata[za0002] = nil
		} else {
			if z.Metadata[za0002] == nil {
				z.Metadata[za0002] = new(TimeSeriesBinary)
			}
...
func (z *TimeSeriesBinary) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if cap(z.LabelsNames) >= int(zb0002) {
		...
		z.LabelsNames = make([]ByteString, zb0002)
	}
	for za0001 := range z.LabelsNames {
		err = z.LabelsNames[za0001].DecodeMsg(dc)
		if err != nil {
	...
	if cap(z.LabelsValues) >= int(zb0003) {
		...
		z.LabelsValues = make([]ByteString, zb0003)
	}
	for za0002 := range z.LabelsValues {
		err = z.LabelsValues[za0002].DecodeMsg(dc)
		if err != nil {
...
func (z *TimeSeriesBinary) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0001 := range z.LabelsNames {
		err = z.LabelsNames[za0001].EncodeMsg(en)
		if err != nil {
			err = msgp.WrapError(err, "LabelsNames", za0001)
			return
		}
	...
	for za0002 := range z.LabelsValues {
		err = z.LabelsValues[za0002].EncodeMsg(en)
		if err != nil {
			err = msgp.WrapError(err, "LabelsValues", za0002)
			return
		}
...
func (z *TimeSeriesBinary) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001 := range z.LabelsNames {
		o, err = z.LabelsNames[za0001].MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "LabelsNames", za0001)
			return
		}
	...
	for za0002 := range z.LabelsValues {
		o, err = z.LabelsValues[za0002].MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "LabelsValues", za0002)
			return
		}
...
func (z *TimeSeriesBinary) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for za0001 := range z.LabelsNames {
		bts, err = z.LabelsNames[za0001].UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "LabelsNames", za0001)
			return
		}
	...
	for za0002 := range z.LabelsValues {
		bts, err = z.LabelsValues[za0002].UnmarshalMsg(bts)
		if err != nil {
			err = msgp.WrapError(err, "LabelsValues", za0002)
			return
		}
...
func (z *TimeSeriesBinary) Msgsize() (s int) {
	s = 1 + msgp.ArrayHeaderSize
	for za0001 := range z.LabelsNames {
		s += z.LabelsNames[za0001].Msgsize()
	}
	s += msgp.ArrayHeaderSize
	for za0002 := range z.LabelsValues {
		s += z.LabelsValues[za0002].Msgsize()
	}
	s += msgp.Int64Size + msgp.Float64Size + msgp.Uint64Size
	if z.Histogram == nil {
		s += msgp.NilSize
	} else {
